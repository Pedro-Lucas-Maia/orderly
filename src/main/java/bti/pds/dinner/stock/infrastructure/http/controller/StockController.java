...
import bti.pds.dinner.stock.application.service.StockService;
import bti.pds.dinner.stock.infrastructure.http.request.CreateStockRequest;
import bti.pds.dinner.stock.infrastructure.http.response.StockResponse;
